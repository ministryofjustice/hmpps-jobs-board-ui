...
context('Sign In', () => {
  ...
  it('Update job flow - check loaded content', () => {
    ...
    jobReviewPage.jobSector().contains('Warehousing and storage')
    ...
    jobReviewPage.charity().contains('Heart foundation')
    ...
    jobReviewPage.hours().contains('Full-time (more than 40 hours)')
    ...
    jobReviewPage.supportingDocumentation().contains('Other - Covering letter')
  ...
  it('Update job - change links flow', () => {
    ...
    jobHowToApplyPage.supportingDocumentationFieldValue('DISCLOSURE_LETTER').click()
    jobHowToApplyPage.supportingDocumentationDetailsField().clear().type('Some more text')
    jobHowToApplyPage.submitButton().click()
    jobReviewPage.supportingDocumentation().contains('Disclosure letter')
