...
describe('jobAddEmployerController', () => {
  ...
  describe('#post(req, res)', () => {
    ...
    beforeEach(() => {
      ...
      setSessionData(req, ['jobAddEmployer', id], mockData)
    })
    ...
    it('On success - Sets session and redirects to jobIsNational', async () => {
      req.body.employerId = 'test id'

      controller.post(req, res, next)

      expect(res.redirect).toHaveBeenCalledWith(addressLookup.jobsv2.jobIsThisNational(id, mode))
    })
  })
})
